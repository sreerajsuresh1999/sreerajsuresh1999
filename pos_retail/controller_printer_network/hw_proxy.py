...
"""
        ...
        if debug is not None:
            ...
            """ % subprocess.check_output('lsusb -v',
    ...
    @http.route('/hw_proxy/scan_item_success',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/scan_item_error_unrecognized',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/payment_request',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/transaction_start',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/transaction_end',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/cashier_mode_activated',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/cashier_mode_deactivated',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/is_scanner_connected',
                type='json',
                auth='none',
                cors='*')
    ...
    @http.route('/hw_proxy/print_pdf_invoice',
                type='json',
                auth='none',
                cors='*')
