odoo.define('pos_retail.giftCardCreatePopupConform', function(require) {
    'use strict';
    ...
    class giftCardCreatePopupConform extends AbstractAwaitablePopup {
        ...
        getConfirmPayload() {
            return {card_no: this.state.CardNumber,
                    select_customer: this.state.SelectCustomer,
                    text_expire_date: this.state.ExpireDate,
                    text_amount: Number(this.state.Amount),
